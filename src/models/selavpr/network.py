...
def get_backbone(args):
    print("Get backbone: use adapter: ", args.use_adapter)
    if args.registers:
        backbone = vit_large(
            patch_size=14,
    ...
    assert not (args.foundation_model_path is None and args.resume is None), (
        "Please specify foundation model path."
    )
